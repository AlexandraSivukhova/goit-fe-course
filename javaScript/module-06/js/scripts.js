...
class Hamburger {
     ...
     */
     calculatePrice() {
       return Hamburger.SIZES[this._size].price + Hamburger.STUFFINGS[this._stuffing].price + this._toppings.reduce((acc, el) => acc + Hamburger.TOPPINGS[el].price, 0);
     }
     ...
     */
    calculateCalories() {
      return Hamburger.SIZES[this._size].calories + Hamburger.STUFFINGS[this._stuffing].calories + this._toppings.reduce((acc, el) => acc + Hamburger.TOPPINGS[el].calories, 0);
    }
}
